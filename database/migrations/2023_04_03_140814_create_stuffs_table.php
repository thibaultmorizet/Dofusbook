...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('stuffs', function (Blueprint $table) {
            ...
            $table->integer("stuff_luck_res")->default(0);
            $table->integer("stuff_strength_res")->default(0);
            $table->integer("stuff_intel_res")->default(0);
            $table->integer("stuff_agility_res")->default(0);
            $table->integer("stuff_percent_neutral_res")->default(0);
            $table->integer("stuff_percent_luck_res")->default(0);
            $table->integer("stuff_percent_strength_res")->default(0);
            $table->integer("stuff_percent_intel_res")->default(0);
            $table->integer("stuff_percent_agility_res")->default(0);
            ...
            $table->integer("stuff_do_strength")->default(0);
            $table->integer("stuff_do_intel")->default(0);
            $table->integer("stuff_do_agility")->default(0);
            $table->integer("stuff_do_luck")->default(0);
