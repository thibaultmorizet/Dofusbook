        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-3 gap-4">
                @foreach($stuffList as $stuff)
                    <div class="p-6 text-gray-900 dark:text-gray-100 dark:bg-gray-800 sm:rounded-lg cursor-pointer" wire:click="goToStuffEdit({{$stuff->id}})">
                        <div class="flex text-center">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-semibold">Niveau : {{$stuff->level}}</span>
                                </div>
